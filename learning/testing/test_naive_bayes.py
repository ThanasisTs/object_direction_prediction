# Script for testing with Naive Bayes
import os
import sys
import numpy as np
import pandas as pd
...
model_names = []
homedir = os.getcwd()
os.chdir('models/naive_bayes/{}'.format(model_path))
...
for matrix in conf_matrix:
	...
	fig.savefig("figs/confusion_matrix/test/naive_bayes/{}/{}_pixels.png".format(model_path, j))
	j += 1
