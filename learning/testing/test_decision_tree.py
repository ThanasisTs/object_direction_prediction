# Script for testing with Decition Trees
import os
import sys
import numpy as np
import pandas as pd
...
model_names = []
homedir = os.getcwd()
os.chdir('models/decision_tree/{}'.format(model_path))
...
for matrix in conf_matrix:
	...
	fig.savefig("figs/confusion_matrix/test/decision_tree/{}/{}_pixels.png".format(model_path, j))
	j += 1
